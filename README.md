...
[![Steam](https://shatteredpixel.com/assets/images/badges/steam.png)](https://store.steampowered.com/app/1769170/Shattered_Pixel_Dun geon/)<br>
...
Si te gusta este juego, considera [apoyarme en Patreon](https://www.patreon.com/ShatteredPixel).

Existe un blog oficial para este proyecto en [ShatteredPixel.com](https://www.shatteredpixel.com/blog/).

El juego también cuenta con un proyecto de traducción alojado en [Transifex](https://explore.transifex.com/shattered-pixel/shattered-pixel-dungeon/).

Tenga en cuenta que **este repositorio no acepta solicitudes de extracción.** El código se proporciona aquí con la esperanza de que otros puedan encontrarlo útil para sus propios proyectos, no para fomentar la contribución de la comunidad. Se agradecen los informes de problemas de todo tipo (errores, sugerencias de nuevas funciones, etc.).

Si deseas trabajar con el código, encontrarás las siguientes guías en `/docs`:
- [Compilación para Android.](docs/getting-started-android.md)

- **[Si planeas distribuir en Google Play, lee el final de esta guía.](docs/getting-started-android.md#distributing-your-app)**
- [Compilación para plataformas de escritorio.](docs/getting-started-desktop.md)
- [Compilación para iOS.](docs/getting-started-ios.md)
- [Cambios recomendados para crear tu propia versión.](docs/recommended-changes.md)
